    ...
    if (feedback) {
        return (
            <div className="max-w-2xl mx-auto text-center space-y-8 animate-in zoom-in duration-500">
                ...
                <div>
                    <h2 className="text-4xl font-bold text-gray-900 mb-2">{feedback.message}</h2>
                    <p className="text-gray-500 text-lg">Tu calificación final: <span className="font-bold text-gray-900">{feedback.calificacion}%</span></p>
                </div>

                <Card className="bg-gray-50 border-0 p-8">
                    <div className="flex justify-around items-center">
                        <div className="text-center">
                            <div className="text-3xl font-bold text-gray-900">{feedback.respuestasCorrectas}</div>
                            <div className="text-xs text-gray-500 uppercase tracking-wider">Correctas</div>
                        </div>
                        <div className="h-12 w-px bg-gray-200" />
                        <div className="text-center">
                            <div className="text-3xl font-bold text-gray-900">{feedback.totalPreguntas}</div>
                ...
                <div className="pt-4">
                    {feedback.aprobado ? (
                        <p className="text-gray-600 mb-6">El módulo ha sido marcado como completado y tu progreso ha sido actualizado.</p>
                    ) : (
                        <p className="text-gray-600 mb-6">Puedes revisar el material e intentar nuevamente cuando estés listo.</p>
                    )}
                    <Button
                        size="lg"
            ...
            <div className="space-y-4">
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <span className="text-gray-400 font-medium"> de {preguntas.length}</span>
                    </div>
            ...
            <Card className="p-8 md:p-12 shadow-xl border-0 ring-1 ring-gray-100">
                ...
                <div className="space-y-4">
                    {currentPregunta.opciones.map((opcion, idx) => (
                        ...
                        >
                            <span className={`text-lg font-medium ${selectedOpcion === idx ? 'text-primary' : 'text-gray-700'}`}>
                                {opcion}
                            </span>
