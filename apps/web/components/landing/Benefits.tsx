                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 bg-teal-500/20 border border-teal-400/30 rounded-full px-4 py-1.5 mb-4 shadow-sm backdrop-blur-md">
                                ...
                                <span className="text-xs font-black text-teal-300 uppercase tracking-wider">Ventaja Competitiva</span>
                            </div>
                            ...
                            {benefits.map((benefit, index) => {
                                return (
                                    <motion.div
                                        ...
                                        className="group bg-slate-900/70 backdrop-blur-md rounded-2xl p-5 border border-slate-700/60 hover:border-teal-400/40 hover:bg-slate-900/90 transition-all duration-300 flex flex-col shadow-md"
                                    >
                                        <div className="w-10 h-10 rounded-xl bg-teal-500/10 border border-teal-400/20 flex items-center justify-center mb-4 group-hover:bg-teal-500/20 group-hover:border-teal-400/30 transition-colors duration-300">
                                            {benefit.icon}
                                        </div>
                        ...
                        <div className="relative aspect-[4/3] sm:aspect-video lg:aspect-[3/4] rounded-3xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.5)] border border-slate-700/80 bg-slate-900 group">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-slate-900/90 border border-slate-700/80 p-5 rounded-2xl shadow-2xl transform transition-all duration-500 hover:scale-105">
                                <div className="flex items-center justify-between mb-1">
                                    <p className="text-[9px] font-black text-teal-400 tracking-widest uppercase">MÉTRICA OPERACIONAL AUDITADA</p>
