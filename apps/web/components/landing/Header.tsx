...
export default function Header() {
    ...
    return (
        <>
            {/* Top Banner */}
            <div className="bg-[#0a1628] text-white py-3 px-4 text-center text-sm border-b border-slate-800">
                <span className="font-medium text-slate-200">
                    Capacitación Vial Profesional <span className="text-teal-400">|</span> Certificaciones con validez nacional
                </span>
            </div>
                ...
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <Link
                                href="/login"
                                className="px-6 py-2.5 border-2 border-primary text-primary rounded-xl font-semibold hover:bg-primary/5 transition-all duration-300"
                            >
                                Login
                            </Link>
                            <Link
                                href="/#contacto"
                                className="px-6 py-2.5 bg-gradient-to-r from-primary to-primary-dark text-white rounded-xl font-semibold hover:scale-105 hover:shadow-lg transition-all duration-300"
                            >
                                Contacto
                            </Link>
                        </div>
                        ...
                        <div className="md:hidden py-4 border-t border-slate-200 animate-slideDown">
                            <div className="flex flex-col space-y-4">
                                ...
                                <Link
                                    ...
                                    className="px-6 py-2.5 border-2 border-primary text-primary rounded-xl font-semibold text-center hover:bg-primary/5 transition-all"
                                >
                                    Login
                                </Link>
                                <Link
                                    href="/#contacto"
                                    onClick={() => setMobileMenuOpen(false)}
                                    className="px-6 py-2.5 bg-gradient-to-r from-primary to-primary-dark text-white rounded-xl font-semibold text-center hover:scale-105 transition-all"
                                >
                                    Contacto
                                </Link>
                            </div>
