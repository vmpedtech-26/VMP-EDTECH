                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                                    ...
                                    <div className="relative flex justify-between items-start">
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-[10px] font-black tracking-[0.2em] text-white/90">VMP SERVICIOS</span>
                                            </div>
                    ...
                    <div className="space-y-10">
                        <div className="space-y-4">
                            ...
                            <h2 className="text-4xl sm:text-6xl font-black text-gray-900 leading-[1.1] tracking-tighter">
                                Tu validación <br />
                        ...
                        <div className="grid sm:grid-cols-2 gap-x-12 gap-y-8">
                            <div className="group">
                                <div className="mb-4 w-12 h-12 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:scale-110 group-hover:rotate-6">
                                    <Shield className="h-6 w-6 text-primary group-hover:text-white transition-colors" />
                                </div>
                                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-2">Seguridad Criptográfica</h3>
                                <p className="text-xs text-gray-500 leading-relaxed font-medium">Cada credencial cuenta con una firma única e inalterable vinculada a tu DNI.</p>
                            </div>
                            ...
                            <div className="group">
                                ...
                                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-2">Acceso Instantáneo</h3>
                                <p className="text-xs text-gray-500 leading-relaxed font-medium">Escanea el código QR para ver el historial de cursada y validez del certificado.</p>
                            </div>
                            ...
                            <div className="group">
                                ...
                                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-2">Ecosistema Digital</h3>
                                <p className="text-xs text-gray-500 leading-relaxed font-medium">Lleva tu certificación en el móvil, lista para ser presentada en cualquier portal de ingreso.</p>
                            </div>
                            ...
                            <div className="group">
                                ...
                                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-widest mb-2">Validez Industrial</h3>
                                <p className="text-xs text-gray-500 leading-relaxed font-medium">Aceptada por las principales operadoras logísticas e industriales del país.</p>
                            </div>
                        </div>
                    </div>
                </div>
