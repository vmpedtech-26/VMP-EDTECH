    ...
    return (
        <main className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 py-6 border-y border-gray-200">
                        ...
                        <div className="flex items-center space-x-3">
                            <ShareButtons title={post.title} url={`/blog/${post.slug}`} text={post.excerpt} />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    className="prose prose-lg max-w-none prose-slate prose-headings:text-[#0A192F] prose-headings:font-bold prose-strong:text-gray-900 prose-blockquote:border-l-[#FFD700] prose-blockquote:bg-gray-50 prose-blockquote:p-6 prose-blockquote:rounded-r-lg"
                    dangerouslySetInnerHTML={{ __html: post.content }}
                />

                <div className="mt-12 pt-8 border-t border-gray-200">
                    <h3 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4">Etiquetas</h3>
                    <div className="flex flex-wrap gap-2">
                        {post.tags.map(tag => (
                            <span key={tag} className="inline-flex items-center px-3 py-1 bg-gray-100 text-gray-700 rounded-md text-sm">
                ...
                {/* Author Bio Simple */}
                <div className="mt-16 p-8 bg-gray-50 rounded-2xl flex flex-col md:flex-row items-center md:items-start gap-6 border border-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {blogPosts
                            ...
                            .slice(0, 3)
                            .map((p) => (
                                <article key={p.slug} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
