...
export const blogPosts: BlogPost[] = [
    {
        slug: 'nueva-disposicion-ansv-2025',
        title: 'Nueva Disposición ANSV 54/2025: Lo que las empresas deben saber',
        excerpt: 'Analizamos los cambios críticos en la normativa de capacitación vial obligatoria para conductores profesionales en Argentina.',
        content: `
      <h2>Actualización Normativa en Argentina</h2>
      ...
      <h3>Puntos Clave de la Nueva Normativa</h3>
      <ul>
        <li><strong>Vigencia Reducida:</strong> Las certificaciones ahora deben renovarse cada 24 meses de forma obligatoria, eliminando las extensiones automáticas previas.</li>
        <li><strong>Módulo Teórico Online:</strong> Se formaliza la validez de la capacitación teórica vía plataformas e-learning certificadas como VMP.</li>
        <li><strong>Examen Práctico Supervisado:</strong> La evaluación práctica debe ser realizada por instructores matriculados con firma digital.</li>
      </ul>

      <blockquote>
        "Esta disposición busca elevar el estándar de seguridad en las rutas nacionales, asegurando que cada conductor profesional mantenga sus conocimientos actualizados frente a las nuevas tecnologías de los vehículos."
      </blockquote>

      <h3>Impacto en las Empresas</h3>
      <p>Las empresas de logística y transporte deben auditar sus legajos de conductores de inmediato. Aquellos con certificaciones obtenidas bajo normativas derogadas tendrán un plazo de 180 días para regularizar su situación.</p>
    `,
    ...
    {
        slug: 'manejo-defensivo-en-zonas-de-montaña',
        title: 'Manejo Defensivo en Zonas de Montaña: Desafíos en los Andes',
    ...
    },
    {
      ...
      <p>Organismos de Argentina, Brasil, Uruguay y Paraguay han iniciado mesas de trabajo para homologar los contenidos de los cursos de Manejo Defensivo. El objetivo es que una certificación emitida bajo el estándar VMP sea reconocida automáticamente por las autoridades de control en cualquier carretera de la región.</p>
